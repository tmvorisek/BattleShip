...
class BattleshipFactory(WebSocketServerFactory):
    def __init__(self, *args, **kwargs):
        super(BattleshipFactory, self).__init__(*args, **kwargs)
        self.clients = {}
    ...
    def findPartner(self, client):
        """
       Find battleship partner for a client. Check if there any of tracked clients
       ...
       """
        ...
        if not available_partners:
            ...
            self.clients[client.peer]["partner"].sendMessage("{\"name\":\"server\", \"message\":\"Found partner!\"}")
            client.sendMessage("{\"name\":\"server\", \"message\":\"Found partner!\"}")
...
if __name__ == "__main__":
    ...
    factory = BattleshipFactory(u"ws://0.0.0.0:8080")
